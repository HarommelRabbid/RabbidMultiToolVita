...
screen.print(480, 25, "System Apps", 1, color.white, color.black, __ACENTER)
...
buttons.read()
if buttons.accept then selgame = menulst2[scroll.sel].id seltitle = menulst2[scroll.sel].title selpath = menulst2[scroll.sel].path dofile("menus/app/app2.lua") end
